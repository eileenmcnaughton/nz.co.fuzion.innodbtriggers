 ...
 * extension.
 */
class CRM_Innodbtriggers_ExtensionUtil {
  const SHORT_NAME = 'innodbtriggers';
  const LONG_NAME = 'nz.co.fuzion.innodbtriggers';
  const CLASS_PREFIX = 'CRM_Innodbtriggers';
...
use CRM_Innodbtriggers_ExtensionUtil as E;

function _innodbtriggers_civix_mixin_polyfill() {
...
function _innodbtriggers_civix_civicrm_config(&$config = NULL) {
  ...
  _innodbtriggers_civix_mixin_polyfill();
}
 ...
 */
function _innodbtriggers_civix_civicrm_postInstall() {
  _innodbtriggers_civix_civicrm_config();
  if ($upgrader = _innodbtriggers_civix_upgrader()) {
 ...
 */
function _innodbtriggers_civix_civicrm_uninstall(): void {
  _innodbtriggers_civix_civicrm_config();
  if ($upgrader = _innodbtriggers_civix_upgrader()) {
 ...
 */
function _innodbtriggers_civix_civicrm_enable(): void {
  _innodbtriggers_civix_civicrm_config();
  if ($upgrader = _innodbtriggers_civix_upgrader()) {
 ...
 * @return mixed
 */
function _innodbtriggers_civix_civicrm_disable(): void {
  _innodbtriggers_civix_civicrm_config();
  if ($upgrader = _innodbtriggers_civix_upgrader()) {
  ...
  if (empty($path)) {
    ...
    foreach ($menu as $key => &$entry) {
      if ($entry['attributes']['name'] == $first) {
        ...
        $found = _innodbtriggers_civix_insert_navigation_menu($entry['child'], implode('/', $path), $item);
      }
    }
    return $found;
  }
 ...
 */
function _innodbtriggers_civix_civicrm_entityTypes(&$entityTypes) {
